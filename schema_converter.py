"""
Convert PostgreSQL schema to DuckDB compatible schema
"""

def convert_postgres_to_duckdb_schema():
    """Convert the existing PostgreSQL schema to DuckDB format"""
...
if __name__ == "__main__":
    schema = convert_postgres_to_duckdb_schema()
    
    # Write to file
    with open("/Users/ahab/pharma-search/duckdb_schema.sql", "w") as f:
        f.write(schema)
    
    print("DuckDB schema created at /Users/ahab/pharma-search/duckdb_schema.sql")