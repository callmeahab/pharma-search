defmodule PharmaLive.Scrapers.Adapters.FillyAdapter do
  ...
  @base_url "https://fillyfarm.rs/prodavnica/"
  ...
  defp extract_product(node) do
    ...
    if title == "" do
      ...
      link = Http.attr(node, ".thumbnail > a", "href")
      image = Http.attr(node, ".product-main-image > img", "src")
