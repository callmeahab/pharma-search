defmodule PharmaLive.Scrapers.Adapters.OgistraAdapter do
  ...
  @base_url "https://www.ogistra-nutrition-shop.com/2-pocetak"
  ...
  defp extract_product(node) do
    ...
    if title == "" do
      ...
      image = Http.attr(node, ".img_block > a > img", "src")
      ...
      %Product{
        ...
        currency: "RSD",
        in_stock: true,
        raw_payload: %{price_raw: price_raw, image: image, category: "suplementi"}
      }
    end
  end
