defmodule PharmaLive.Scrapers.Adapters.FitnessShopAdapter do
  ...
  defp extract_product(node) do
    ...
    if out_of_stock do
      ...
      if title == "" do
        ...
        price_raw = Http.text(node, ".product-price")
        link = Http.attr(node, ".img-link", "href")
        image = Http.attr(node, ".img-link > img", "src")
